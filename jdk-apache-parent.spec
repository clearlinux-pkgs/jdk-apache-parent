...
%package data
Summary: data components for the jdk-apache-parent package.
Group: Data

%description data
data components for the jdk-apache-parent package.
...
%install
xmvn-install  -R .xmvn-reactor -n apache-parent -d %{buildroot}
...
%files data
%defattr(-,root,root,-)
/usr/share/maven-metadata/apache-parent.xml
